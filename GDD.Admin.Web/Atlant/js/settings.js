var site_settings = '<div class="ts-button"  style="display:none;">'
    ...
    +'<div class="ts-body">'
        ...
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox checked" name="st_sb_fixed" value="1" checked/> Fixed Sidebar</label>'
        +'</div>'
        +'<div class="ts-row">'
            + '<label class="check"><input type="checkbox" class="icheckbox checked" name="st_sb_scroll" value="1" checked/> Scroll Sidebar</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_right" value="1"/> Right Sidebar</label>'
        +'</div>'
        +'<div class="ts-row">'
            + '<label class="check"><input type="checkbox" class="icheckbox checked" name="st_sb_custom" value="1" checked/> Custom Navigation</label>'
        +'</div>'
        +'<div class="ts-row">'
